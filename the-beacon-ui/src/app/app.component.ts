...
import { DrinkprofileComponent } from './components/drinkprofile/drinkprofile.component';


@Component({
  selector: 'app-root',
  standalone: true,
  imports: [CommonModule, DisplayRecipeComponent, LiquidIngredientListComponent, DrinkprofileComponent],
